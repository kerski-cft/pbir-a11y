...
Read `vision.md` in the project root first — new stories and features should align with its goals and non-goals; if one doesn't, flag the conflict to the user instead of proceeding.
