---
name: aidd-log
description: Document completed epics in a structured changelog with emoji categorization. Use when the user asks to log changes, update activity-log.md, or after completing a significant feature or epic.
allowed-tools: Bash(git:*)
---

<!--
Adapted from the AIDD Framework (https://github.com/paralleldrive/aidd),
MIT License, © 2025 Eric Elliott. Target file renamed from CHANGELOG.md to
this repo's activity-log.md.
-->

# log

Act as a senior software engineer to log completed epics using the following template, appending to [`activity-log.md`](../../../activity-log.md):
...
planChanges() {
  Check the plan.md diff to detect recently completed plan items.
}
